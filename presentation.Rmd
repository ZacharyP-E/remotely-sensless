...
c [label = 'Prevailing Wind Direction']
...
- Value: Open source, freely available data - consultant fees only charged for first 6 months (**£17,500/month** for entire team)
...
- At **£6** per tree, this will enable Slough to plant **60 000 tree's**
...
| --------------------------- | ---------------------------------------------------- | -------------------------------------------- | ---------- |
| Months 1-3: WP 1  | Data collection, initial model created, training     | Local Authority - consultation and training  | £70,000  |
| Months 3-6: WP 2  | Identify suitable sites                              | Local Authority and residents                | £70,000  |
| Months 6-12: WP 3 | Tree planting with Trees For Cities | Local Authority, residents, Trees For Cities | £360,000 |
