...
library(cowplot)
ggdraw() + 
  draw_image('images/site.png', width = 0.5) + 
  draw_image('images/digi.png', width = 0.5, x = 0.5)
```


Slough's Urban Forest Programmes (Source: [Slough Borough Council](https://www.slough.gov.uk/environment/trees-hedges-1/8), n.d.)
